...
/// Tool definition for reporting dinner attendance.
abstract final class ReportAttendanceTool {
  /// The registered tool name.
  static const String name = 'report_attendance';

  /// The serialized tool definition.
  static Map<String, dynamic> get definition {
    return <String, dynamic>{
      'name': name,
      'description': 'Reports whether the guest attended the dinner.',
      'input_schema': <String, dynamic>{
        'type': 'object',
        'properties': <String, dynamic>{
          'match_id': <String, dynamic>{'type': 'string'},
          'user_id': <String, dynamic>{'type': 'string'},
          'attended': <String, dynamic>{'type': 'boolean'},
        },
        'required': <String>['match_id', 'user_id', 'attended'],
      },
    };
  }
  ...
  static Future<Map<String, dynamic>> handle(
    ...
    final Result result = await repository.reportAttendance(
      matchId: input['match_id'] as String,
      userId: input['user_id'] as String,
      attended: input['attended'] as bool,
    );
