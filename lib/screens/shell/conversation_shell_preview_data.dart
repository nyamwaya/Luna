...
abstract final class ConversationShellPreviewData {
  ...
  static HomeDashboardView _buildHomeDashboardView() {
    return HomeDashboardView(
      ...
      activeCircleCount: 3,
      circles: const <HomeCircleSummary>[
        HomeCircleSummary(
          id: 'circle-rec-center-ballers',
          name: 'Rec Center Ballers',
          city: 'Minneapolis',
          vibe: 'Basketball, patios, and easy weeknight dinners',
          memberCount: 8,
          pairingFrequency: 'weekly',
          inviteCode: 'BALLERS',
          nextPairingLabel: 'Next pairing this Thursday',
        ),
        HomeCircleSummary(
          id: 'circle-mpls-foodies',
          name: 'MPLS Foodies',
          city: 'Minneapolis',
          vibe: 'Neighborhood spots and trying new menus',
          memberCount: 6,
          pairingFrequency: 'biweekly',
          inviteCode: 'FOODIES',
          nextPairingLabel: 'Next pairing next week',
        ),
      ],
      upcomingDinners: const <HomeUpcomingDinner>[
        HomeUpcomingDinner(
          id: 'dinner-rec-center-ballers-mar-19',
          title: 'March Dinner',
          circleName: 'Rec Center Ballers',
          venue: 'Spoon & Stable',
          city: 'Minneapolis',
          dateLabel: 'Thursday, Mar 19th',
          timeLabel: '7:30 PM',
          status: 'confirmed',
          seatsLeft: 0,
        ),
        HomeUpcomingDinner(
          id: 'dinner-mpls-foodies-mar-22',
          title: 'Sunday Supper',
          circleName: 'MPLS Foodies',
          venue: 'Colita',
          city: 'Minneapolis',
          dateLabel: 'Sunday, Mar 22nd',
          timeLabel: '6:00 PM',
          status: 'inviting',
          seatsLeft: 2,
        ),
